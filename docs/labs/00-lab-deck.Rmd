...
We believe there is value in understanding how companies use AI to develop and deploy the technologies that are changing the world. 
...
graph that you've ever stored on your computer. Twenty years ago, if your
...
<img src="img/00/todays_offerings.png" style="display:block; margin: 0 auto; width: 100%">
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/rNgswRZ2C1Y" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
