...
#   - name: Adrian Esparza
#     url: https://github.io
#     affiliation: HPE Greenlake
#     affiliation_url: https://www.hpe.com/us/en/greenlake.html
#     mailto: adrian.esparza@hpe.com
...
<!-- --- -->
<!-- title: "Thinking in Data Science" -->
<!-- description: | -->
...
<!--
```{r title-page, layout="l-page", eval=T, fig.width=20, fig.asp=.25}

knitr::include_url("https://word.rodeo/ds_brownbag/")
```

 <img src="img/hpe_ai5.jpeg" style="display:flex; margin: -10 auto; width: 100%">
...
ggplot(aes(x = x, y = value), data = gdat) +
  geom_ribbon(aes(ymin = se_lower, ymax = se_upper, group = variable),
              fill = 'gray98') +
  geom_line(aes(group = variable), color = '#ff8300') +
...
ggplot() +
  ...
  geom_line(aes(x = X_test, y = mu), size = 1, color = '#ff8300') +
  geom_point(
    aes(x = X_train, y = y_train),
    size = 4,
    color = '#0085a1',
